            ...
            {[
              {
                ...
                desc: "Our values are not just words on a page — they are embedded in every interaction, decision, and deliverable we produce.",
                highlight: "Integrity & Objectivity",
              },
              {
                title: "With Every Client",
                desc: "We build lasting relationships founded on trust, confidentiality, and a genuine commitment to our clients' success.",
                highlight: "Client Focus & Confidentiality",
              },
              {
                title: "Through Continuous Growth",
                desc: "We invest in our people, embrace innovation, and pursue excellence to ensure we consistently deliver the highest quality.",
